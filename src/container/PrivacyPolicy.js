...
function PrivacyPolicy() {
  return (
    <div className="mx-[auto] w-[1184px] mt-[70px] mb-[70px] tablet:w-auto tablet:mx-0 tablet:mt-[40px] tablet:pr-[0] largeMobile:pl-[10px] smallLaptop:w-[1050px] text-[12px]">
      <h1 className="text-[48px] tablet:text-[36px]">Privacy Policy</h1>
      <p className="text-[16px] text-[#BFB8B8]">Last updated: April 03, 2023</p>
      <p className="mt-2">
      ...
      <h1 className="text-[24px] mt-10">Interpretation and Definitions</h1>
      <h2 className="text-[16px] mt-4">Interpretation</h2>
      <p>
      ...
      <h2 className="text-[16px] mt-4">Definitions</h2>
      ...
      <ul className="list-disc ml-10">
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Cosmocloud Private Limited, HD-083, Wework
            Berger Delhi One, C-001/A2, Sector 16B, Noida, Uttar Pradesh, India
            - 201303.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Cosmocloud, accessible from{" "}
            <a href="https://cosmocloud.io" rel="noreferrer" target="_blank">
              https://cosmocloud.io
            </a>
          </p>
        </li>
      ...
      <h2 className="text-[16px] mt-4">Types of Data Collected</h2>
      <h3 className="text-[14px] mt-4 font-semibold">Personal Data</h3>
      <p>
      ...
      <h3 className="text-[14px] mt-4 font-semibold">Usage Data</h3>
      ...
      <h3 className="text-[14px] mt-4 font-semibold">
      ...
      <h2 className="text-[16px] mt-4">Use of Your Personal Data</h2>
      ...
      <h2 className="text-[16px] mt-4">Retention of Your Personal Data</h2>
      <p>
      ...
      <h2 className="text-[16px] mt-4">Transfer of Your Personal Data</h2>
      <p>
      ...
      <h2 className="text-[16px] mt-4">Delete Your Personal Data</h2>
      <p>
      ...
      <h2 className="text-[16px] mt-4">Disclosure of Your Personal Data</h2>
      <h3 className="text-[14px] mt-4 font-semibold">Business Transactions</h3>
      <p>
      ...
      <h3 className="text-[14px] mt-4 font-semibold">Law enforcement</h3>
      <p>
      ...
      <h2 className="text-[16px] mt-4">Security of Your Personal Data</h2>
      <p>
      ...
      <h1 className="text-[24px] mt-10">Children's Privacy</h1>
      <p>
      ...
      <h1 className="text-[24px] mt-10">Links to Other Websites</h1>
      <p>
      ...
      <h1 className="text-[24px] mt-10">Changes to this Privacy Policy</h1>
      <p>
      ...
      <h1 className="text-[24px] mt-10">Contact Us</h1>
      <p>
        If you have any questions about this Privacy Policy, You can contact us:
      </p>
      <ul className="list-disc ml-10">
        <li>By email: contact@cosmocloud.io</li>
      </ul>
    </div>
  );
}
