...
function Section3() {
  ...
  return (
    <div className="flex items-center justify-center">
      <div className="flex items-center justify-between w-[800px] bg-[#292640] pt-[3%] pb-[3%] p-[4%] pr-[4%] rounded-lg mt-[70px] mb-[70px] largeMobile:w-[100%] largeMobile:rounded-0 largeMobile:p-9 largeMobile:flex-col largeMobile:text-center largeMobile:text-[22px]">
