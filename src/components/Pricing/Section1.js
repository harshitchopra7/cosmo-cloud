...
function Section1() {
  ...
  return (
    <div className="px-[auto] pb-[72px] mx-[auto] w-[1184px] mobile:w-[330px] smallLaptop:w-[1050px] tablet:w-[850px]">
      ...
      <div className="flex justify-center">
          <div className="mt-8 grid grid-cols-3 gap-9 mobile:flex mobile:flex-col mobile:gap-6 tablet:gap-5">
            {plans.map((val) => (
              <Section1Cards
                title={val.title}
