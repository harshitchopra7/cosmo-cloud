...
function Section1Cards({
  ...
  return (
    <div className="bg-[#1D1B2D] w-[392px] min-h-[445px] px-6 py-7 rounded-xl flex flex-col justify-between largeMobile:w-[100%] largeMobile:ml-0 smallLaptop:w-[330px] tablet:w-[270px] smallTablet:w-[340px]">
      <div>
