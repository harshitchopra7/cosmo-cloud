...
function Banner() {
  return (
    <div className="text-center flex items-center justify-center flex-col mt-12 mobile:w-[330px] mobile:mx-[auto] mobile:mb-1 tablet:w-[850px] mx-[auto] smallTablet:w-[700px]">
      ...
      <div className="font-light text-[72px] leading-[72px] smallTablet:text-6xl text-white mobile:text-[32px] mobile:leading-[40px]">
