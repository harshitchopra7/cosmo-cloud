...
import { ReactComponent as ReleasesImage } from "../../../assets/features/flowEngine2.svg";
...
const data = [
  ...
  },
  {
    ...
    image: (
      <TemplatesImage className="w-[640px] h-[400px] tablet:w-[448px] tablet:h-[280px] tablet:w-[320px] tablet:h-[200px]" />
    ),
  },
  {
    ...
    image: (
      <ReleasesImage className="w-[640px] h-[400px] tablet:w-[448px] tablet:h-[280px] tablet:w-[320px] tablet:h-[200px]" />
    ),
  },
  {
    ...
    image: (
      <ModelSchemaImage className="w-[640px] h-[400px] tablet:w-[448px] tablet:h-[280px] tablet:w-[320px] tablet:h-[200px]" />
    ),
  },
  {
    ...
    image: (
      <ConfigsImage className="w-[640px] h-[400px] tablet:w-[448px] tablet:h-[280px] tablet:w-[320px] tablet:h-[200px]" />
    ),
  },
];
...
const Features = () => {
  return (
    <div className="mt-[100px] mb-[70px] mx-[auto] w-[1180px] mobile:w-[330px] smallLaptop:w-[1050px] tablet:w-[700px] largeMobile:w-[576px] flex flex-col gap-[50px]">
      {data.map((info, index) => {
        return (
          <div
            className={`flex items-center flex-row justify-between tablet:justify-center gap-[20px] ${
              index & 1 && "flex-row-reverse"
            }  largeMobile:flex-col largeMobile:flex-col-reverse`}
