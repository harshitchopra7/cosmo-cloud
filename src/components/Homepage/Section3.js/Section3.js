...
function Section3() {
  ...
  return (
    <div className="mt-[70px] mb-[70px] mx-[auto] w-[1184px] mobile:w-[330px] smallLaptop:w-[1050px] tablet:w-[850px]">
      ...
      <div className="hidden largeMobile:flex flex-col items-center justify-center">
        <div>
          {data.map((val) => (
            <Section3MobileCards
              id={val.id}
